...
Property {
    ##[ a <- Int, b <- Int ]##
    my $result1 = MyModule::add($a, $b);
    my $result2 = MyModule::add($b, $a);
    $result1 == $result2;
}, name => 'When I add two numbers the result should not rely on the order of the numbers';

Property {
    ##[ a <- Int, b <- Int ]##
    my $result1 = MyModule::add( MyModule::add($a, 1), 1);
    my $result2 = MyModule::add($a, 2);
    $result1 == $result2;
}, name => 'Adding 1 twice is the same as adding 2 once';

Property {
    ##[ a <- Int, b <- Int ]##
    my $result1 = MyModule::add($a, 0);
    $result1 == $a;
